...
questions = ['How can I give my GitLab CI job private information?']
teaching = 5
...
{{< callout type="note" title="Running examples with variables" >}}
...
{{< callout type="note" title="Base-64 encoding?" >}}
...
{{< callout type="note" title="Service Account or Not?" >}}
...
{{< callout type="note" title="How to make a service account?" >}}
...
1. Navigate to the `Settings -> CI/CD` of your repository
  ![CI/CD Repo Settings](fig/repo-settings-ci-cd.png)
2. Expand the `Variables` section on this page by clicking `Expand`
  ![CI/CD Variables Click Expand](fig/repo-settings-ci-cd-variables-click-expand.png)
...
{{< callout type="caution" title="Attention" >}}
...
{{< /callout >}}
  ...
  ![CI/CD Variables Specified](fig/repo-settings-ci-cd-variables-specified.png)
...
![CI/CD Artifacts Download](fig/ci-cd-artifacts-download.png)

or if you click through to a `skim_ggH` job, you can browse the artifacts

![CI/CD Artifacts Browse](fig/ci-cd-artifacts-browse.png)
