...
questions = ['I have code already in GitLab, how can I add CI to it?']
teaching = 5
...
![CI/CD Two Parallel Jobs](fig/ci-cd-two-parallel-jobs.png)
...
build_skim_latest:
  ...
  allow_failure: yes
```
{{< callout type="note" title="Building only on changes?" >}}
