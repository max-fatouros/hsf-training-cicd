...
objectives = ['Matrix workflows.', 'Make reusable/flexible CI/CD jobs.']
questions = ['How can we make variations of our builds?']
teaching = 10
...
{{< lesson/image src="fig/parallel-example.png" alt="Parallel jobs running" width="60%" >}}
...
{{< lesson/image src="fig/parallel-os.png" alt="Parallel OS builds" width="60%" >}}
...
{{< lesson/image src="fig/parallel-versions.png" alt="Parallel OS with versions" width="60%" >}}
...
{{< lesson/image src="fig/parallel-specified.png" alt="Specified OS and version pairs" width="60%" >}}
...
{{< solution title="Remember what we have so far" >}}
```yml
hello_world:
  script:
    - echo "Hello World"
