...
questions = ['How can I run my skimming code in the GitLab CI/CD?']
teaching = 5
...
{{< callout type="note" title="Using Dependencies" >}}
...
{{< callout type="note" title="Don't want to use dependencies?" >}}
...
{{< challenge title="Set The Right Image" >}}
...
{{< callout type="note" title="What files are in here?" >}}
...
{{< callout type="note" title="How many events to run over?" >}}
