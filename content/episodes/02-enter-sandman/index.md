...
objectives = ['Understand exit codes.', 'Learn how to print exit codes.', 'Learn how to set exit codes in a script.', 'Learn how to ignore exit codes.', 'Create a script that terminates in success/error.']
questions = ['What is an exit code?']
teaching = 10
title = 'Exit Codes'
weight = 20
+++
...
{{< callout type="note" title="Exit Code is not a Boolean" >}}
