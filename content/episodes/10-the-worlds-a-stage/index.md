...
objectives = ['Make multiple stages and run some jobs in serial.']
...
![CI/CD Default Stages in Pipeline](fig/ci-cd-default-stages.png)

{{< callout type="note" title="Default job stage" >}}
...
![CI/CD Pipeline Two Stages](fig/ci-cd-pipeline-two-stages.png)
...
{{< callout type="note" title="Default CI/CD stages" >}}
