...
objectives = ['Learn where to find more details about everything for the GitLab CI.', 'Understand the structure of the GitLab CI YAML file.']
questions = ['What is the GitLab CI specification?']
teaching = 5
title = 'YAML and CI'
weight = 40
+++
...
{{< callout type="note" title="`script` commands" >}}
...
{{< callout type="note" title="Parallel or Serial Execution?" >}}
...
```
{{< callout type="note" title="Stages???" >}}
...
{{< callout type="note" title="Understanding the Reference" >}}
